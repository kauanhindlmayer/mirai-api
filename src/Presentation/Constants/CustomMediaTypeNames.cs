...
public static class CustomMediaTypeNames
{
    public static class Application
    {
        ...
        public const string HateoasJson = "application/vnd.mirai.hateoas+json";
        public const string HateoasJsonV1 = "application/vnd.mirai.hateoas.1+json";
        public const string HateoasJsonV2 = "application/vnd.mirai.hateoas.2+json";
