    ...
    IEntityTypeConfiguration<RetrospectiveItem>
{
    public void Configure(EntityTypeBuilder<Retrospective> builder)
    {
        ...
        builder.Property(r => r.MaxVotesPerUser).IsRequired();
        builder.Property(r => r.Template).IsRequired();
    ...
    public void Configure(EntityTypeBuilder<RetrospectiveColumn> builder)
    {
        ...
        builder.Property(rc => rc.Title).HasMaxLength(255).IsRequired();
        builder.Property(rc => rc.RetrospectiveId).IsRequired();
    ...
    public void Configure(EntityTypeBuilder<RetrospectiveItem> builder)
    {
        ...
        builder.Property(ri => ri.Content).IsRequired();
        builder.Property(ri => ri.Votes).IsRequired();
        builder.Property(ri => ri.RetrospectiveColumnId).IsRequired();
        builder.Property(ri => ri.AuthorId).IsRequired();
