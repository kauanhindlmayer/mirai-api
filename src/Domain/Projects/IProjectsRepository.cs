...
{
    Task<Project?> GetByIdWithOrganizationAndUsersAsync(Guid id, CancellationToken cancellationToken = default);
    Task<Project?> GetByIdWithUsersAndTeamsAsync(Guid id, CancellationToken cancellationToken = default);
